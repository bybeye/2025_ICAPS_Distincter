...
fast_downward_plugin(
    NAME PLUGIN_PERFECT2
    HELP "Generate states from plan"
    SOURCES
        search_engines/plugin_perfect2
    DEPENDS PERFECT_SEARCH2 SEARCH_COMMON
)

fast_downward_plugin(
    NAME PLUGIN_PERFECT3
    HELP "Generate states from plan"
    SOURCES
        search_engines/plugin_perfect3
    DEPENDS PERFECT_SEARCH3 SEARCH_COMMON
)
...
fast_downward_plugin(
    NAME PERFECT_SEARCH2
    HELP "Generate states from plan"
    SOURCES
        search_engines/perfect2
    DEPENDS ORDERED_SET SUCCESSOR_GENERATOR
    DEPENDENCY_ONLY
)

fast_downward_plugin(
    NAME PERFECT_SEARCH3
    HELP "Generate states from plan"
    SOURCES
        search_engines/perfect3
    DEPENDS ORDERED_SET SUCCESSOR_GENERATOR
    DEPENDENCY_ONLY
)
...
# fast_downward_plugin(
#     NAME ML_HEURISTIC
#    HELP "The ML heuristic"
#    SOURCES
#        heuristics/ml_heuristic
# )
...
fast_downward_plugin(
    ...
    HELP "The ML heuristic"
    SOURCES
 	heuristics/ml_heuristic2
	heuristics/base_graph
	heuristics/pog
	heuristics/pog2
)
