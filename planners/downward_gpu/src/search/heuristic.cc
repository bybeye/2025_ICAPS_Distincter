...
Heuristic::Heuristic(const plugins::Options &opts) : Evaluator(opts, true, true, true),
...
std::vector<float> Heuristic::compute_result_batch(const std::vector<State> &states) {
