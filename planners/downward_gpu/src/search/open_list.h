...
protected:
    ...
    */
    ...
    virtual void do_insertion(float h,
                              const Entry &entry) = 0;
...
public:
    ...
    */
    ...
    void insert(float h, const Entry &entry);
...
template<class Entry>
void OpenList<Entry>::insert(EvaluationContext &eval_context, const Entry &entry) {
...
template<class Entry>
void OpenList<Entry>::insert(float h, const Entry &entry) {
    // TODO preferred
